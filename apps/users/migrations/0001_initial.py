    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.CharField(max_length=20, verbose_name='用户姓名')),
                ...
                ('s_name', models.CharField(default='', max_length=40, verbose_name='收货人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ImageField(upload_to='banner/', verbose_name='轮播图')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '轮播图',
